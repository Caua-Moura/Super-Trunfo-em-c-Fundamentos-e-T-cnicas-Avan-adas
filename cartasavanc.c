...
int main (){
    ...
    superpoder1 = (float)populacao + aKm² + pib + pontosTuristicos + pibc + (dp > 0 ? (1.0f/dp) : 0);
    superpoder2 = (float)populacao2 + aKm²_2 + pib_2 + pontosTuristicos2 + pibc2 + (dp2 > 0 ? (1.0f/dp2) : 0);
